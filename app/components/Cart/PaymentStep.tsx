...
const PaymentStep: React.FC<PaymentStepProps> = ({
  ...
  const handleProceed = async () => {
    ...
    try {
        ...
        navigation.navigate('ProfileTab', {
          ...
          params: {
            order: {
              ...
              placedAt: confirmData.data?.paidAt ?? new Date().toISOString(),
              subtotal: orderData.subtotal,
              shippingFee: orderData.shipping_fee,
              grandTotal: confirmData.data?.amount ?? orderData.amount_paid,
              paymentMethod: selectedPayment,
              items: orderData.order_items ?? orderPayload.items,
              shippingAddress: orderData.shipping_address,
              storeGroups: orderData.store_groups ?? [],
      ...
      // ✅ Navigate to Order Tracking screen after payment confirmation
      navigation.navigate('ProfileTab', {
        screen: 'OrderTracking',
        params: {
          order: {
